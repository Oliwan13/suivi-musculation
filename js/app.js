...
// ──  SaveQueue → js/core/state.js  ───────────────────────────────────────
        ...
        function initSessionSummary() {
            ...
            document.getElementById('summaryPrintBtn').addEventListener('click', () => {
                // Injecter la date pour le footer CSS
                document.body.setAttribute('data-print-date', new Date().toLocaleDateString('fr-FR', {
            ...
            document.getElementById('summaryShareBtn').addEventListener('click', () => {
                ...
                if (navigator.share) {
                    navigator.share({
                        title: '💪 Séance Lyftiv',
                        text,
                        url: 'https://oliwan13.github.io/suivi-musculation/'
                    }).catch(() => {
                        // fallback clipboard si share annulé
